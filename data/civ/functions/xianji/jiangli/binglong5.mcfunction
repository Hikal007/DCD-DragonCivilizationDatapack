scoreboard players set xuyuan.binglong.global5 global 1
scoreboard players set xuyuan.binglong global 5
tellraw @a [{"text": " "}]
tellraw @a [{"text": " "}]
tellraw @a [{"text": " "}]
tellraw @a [{"text": " "}]
...
tellraw @a [{"text": " "}]
tellraw @a [{"text": "【全服公告 - 许愿池】 ","color": "red","bold": true},{"text": "文明 弗罗斯蒂克 的许愿等级已达到 5 级！","color":"aqua","bold":false}]
tellraw @a [{"text": " "}]
tellraw @a [{"text": "--------------------------------","color": "red","bold": true}]
